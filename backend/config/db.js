...
if (connectionUrl) {
    ...
    const database = process.env.MYSQLDATABASE || process.env.DB_NAME || 'career_assessment';
...
pool.getConnection()
    .then((connection) => {
        const activeDb = process.env.MYSQLDATABASE || process.env.DB_NAME || 'career_assessment';
