...
CREATE TABLE `admins` (
  ...
  `role` enum('SuperAdmin','Counselor') NOT NULL,
...
INSERT INTO `admins` VALUES (5,'Super admin','admin@example.com','$2b$10$tcQzAMLp4Yq2fTuAg0Q8jOvYzvD6QHaDo.biXhwLi3ec12gOEe/nC','SuperAdmin','2026-09-12 08:24:09'),(6,'Test Admin','testadmin@reachindia.org','$2b$10$SXD4ZtLyCN4FyMB1FSiXPeWMip597ISU8mW2mdAzaYYpRO2ik4GV.','SuperAdmin','2026-09-12 08:29:41');
...
CREATE TABLE `assessment_results` (
  ...
  CONSTRAINT `assessment_results_ibfk_2` FOREIGN KEY (`assessment_id`) REFERENCES `assessments` (`id`) ON DELETE CASCADE
...
INSERT INTO `notifications` VALUES (4,17,'Assessment Reminder','You have not completed your assessment. Please continue where you left off.','reminder',0,'2026-09-12 08:04:48'),(5,17,'Important Update','We have updated our career database to provide better recommendations.','update',0,'2026-09-12 08:04:48'),(6,17,'Welcome!','Welcome to Career Assessment System! Take your first assessment to unlock personalized recommendations.','info',0,'2026-09-12 08:04:48');
...
INSERT INTO `otps` VALUES (1,'testotp@example.com','926572','signup','2026-09-12 12:38:17',1,'2026-09-12 06:58:17'),(2,'rajeshchatterjee621@gmail.com','616343','signup','2026-09-12 12:44:33',0,'2026-09-12 07:04:33'),(3,'ritamchatterjee08@gmail.com','445282','signup','2026-09-12 13:07:32',1,'2026-09-12 07:27:32'),(4,'ritamchatterjee08@gmail.com','296182','signup','2026-09-12 13:09:18',0,'2026-09-12 07:29:18'),(5,'test_unverified_99@gmail.com','969643','signup','2026-09-12 13:32:30',1,'2026-09-12 07:52:30'),(6,'test_unverified_99@gmail.com','641213','signup','2026-09-12 13:32:42',1,'2026-09-12 07:52:42'),(7,'ritamchat08@gmail.com','642262','signup','2026-09-12 13:43:57',1,'2026-09-12 08:03:57');
...
INSERT INTO `system_settings` VALUES (1,'passing_score','40','2026-08-11 14:27:58'),(2,'maintenance_mode','false','2026-08-11 14:27:58');
...
CREATE TABLE `user_responses` (
  ...
  CONSTRAINT `user_responses_ibfk_1` FOREIGN KEY (`assessment_id`) REFERENCES `assessments` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_responses_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_responses_ibfk_3` FOREIGN KEY (`question_id`) REFERENCES `questions` (`id`) ON DELETE CASCADE
...
INSERT INTO `users` VALUES (17,'Ritam Chatterjee','ritamchat08@gmail.com','9832690351','bachelors',21,'IT','Full stack developer',1,'$2b$10$3rDwazRdZey7kFjwDj95buZbPntChWP8MuX1oehcbFtXVSH/owOfu','2026-09-12 08:03:57','2026-09-12 08:04:27','male','2004-11-29','Durgapur','West Bengal','713206',1);
...
-- Dump completed on 2026-09-12 15:06:29
